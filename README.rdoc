...
* fast parse(2.5 - 5 times faster than ruby eval), and less network traffic.
 MRI 1.8.7
  [data2]
  ruby eval parse. 5000 times. elapsed time 6.793939
  javabin parse.    5000 times. elapsed time 1.601022
  4.24350133852002 times

 REE 1.8.7
  [data2]
  ruby eval parse. 5000 times. elapsed time 4.739839
  javabin parse.    5000 times. elapsed time 1.148916
  4.12548785115709 times

 YARM 1.9.2 pre1
  [data2]
  ruby eval parse. 5000 times. elapsed time 6.552406579
  javabin parse .   5000 times. elapsed time 1.459406626
  4.489774448235238 times
